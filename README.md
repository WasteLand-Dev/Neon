...
Happy last autumn month!

### Changelog:
- Update betterfpsdist to 2.0
- Update CraftPresence to 1.9.6
- Update fabric api to 0.66.0
- Update FastLoad to 1.3.3
- Update lithium to 0.10.2
- Update modmenu to 4.1.0
- Update Presence Footsteps to 1.6.3
- Update Complementary Reimagined shaders to 1.3.2
